...
export default function LandingPage() {
	return (
		<div className='flex flex-col min-h-screen'>
			...
			{/* Hero Section */}
			<section className='w-full py-12 md:py-24 lg:py-32 xl:py-48 bg-gradient-to-b from-background to-muted flex flex-row'>
				<div className='flex flex-col lg:flex-row items-center justify-between w-full mx-10 gap-2'>
